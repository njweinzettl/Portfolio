...
<style>
    ...
    footer{
        ...
        padding: 50px 50px 80px; /* top/left & right/ bottom */
        bottom: 0;
        left: 0;
        right: 0;
        height: auto;
